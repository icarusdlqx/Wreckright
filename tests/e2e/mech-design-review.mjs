...
async function installFixture({ base, settings }) {
  ...
  if (!response.ok) throw new Error('BASE_URL must serve Ironmuster source through Vite');
...
function contactSheet(records, roster) {
  ...
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Ironmuster · real model review</title><style>
