...
export function SaveConfigurationDialog({ catalog, design, storedIds, onSave, onCancel }: {
  catalog: Catalog;
  design: Design;
  ...
  return <div className="bay-save-backdrop">
    <section ref={dialog} role="dialog" aria-modal="true" aria-labelledby="bay-save-title"
      ...
      <h2 id="bay-save-title">Save a new configuration</h2>
      <p>Give this fitted build a name. It will appear in the MechBay and mission deployment lists in this browser.</p>
      <label htmlFor="bay-save-name">Configuration name</label>
