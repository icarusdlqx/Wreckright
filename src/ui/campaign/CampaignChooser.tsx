  ...
  return (
    <div className="campaign-chooser-backdrop">
      ...
      >
        ...
        {initial || newRun ? <p>One campaign for each faction, with its own company, contracts and story. Choose your side and difficulty; difficulty stays with that campaign. Your current company is kept in Load Game before starting another.</p> : <p>
        ...
        <p className="campaign-chooser-selection">
          {isCurrent && !initial && !newRun ? 'This is the campaign already in progress.' : `Selected: ${selected?.name ?? selectedId}`}
        </p>
