...
export function EnemyForceSetup(props: EnemyForceSetupProps) {
  const lance = briefingLanceFor(props.catalog, props.missionId, props.lance, props.onLance, props.onCustomise, props.difficultyId, props.faction);
  ...
  return <section className="enemy-force-setup briefing-lance" data-testid="enemy-force-setup">
    ...
    <div className="briefing-setup-grid">
      <label className="setup-field"><span>Enemy faction</span>
        <select value={props.faction} data-testid="enemy-faction-picker"
        ...
        <small className="setup-description">Choosing a faction refills the enemy berths and limits mech choices. Mixed company allows both cultures.</small>
      </label>
